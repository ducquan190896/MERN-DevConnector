...
import {CreateProfileByToken, GetProfileByToken, ResetProfile} from '../actions/profileAction'
...
function CreateProfileForm() {
    ...
    const onSubmit = (e) => {
        e.preventDefault()
       dispatch(CreateProfileByToken(formdata))
        setFormdata({
            status: '',
            location: '',
            skills: '',
    ...
    return (
        <div className='w-1/3 mx-auto py-10 min-h-screen flex flex-col items-left justify-start'>
            <h1 className='mb-8 text-4xl text-sky-500 font-bold font-mono'>Create Profile</h1>
            <form onSubmit={onSubmit} action="" className='w-full my-2 flex flex-col items-left justify-center' >
                ...
                <button type='submit' className='w-full btn bg-sky-500 border-none rounded-none my-4'>Update</button>
                <div>
